...
const sceneArtByEpisode = {
  ...
  ep12: [
    ...
    },
    {
      ...
      alt: "Soren Ashvale appearing by remote projection above the Foundation pool with Valemere timing sheets",
    },
    {
  ...
  ep31: [
    ...
    },
    {
      ...
      alt: "Aira, Rhea Valmont, Professor Iris Valen, and Maelin planning protected recovery logistics around Elira's bed",
    },
    {
  ...
  ep37: [
    ...
    },
    {
      ...
      alt: "Nera and Darian recognizing Noctis reserve crest-lights behind the relay that do not belong to Lucien",
      orientation: "wide",
    },
    {
...
const episode1Scenes = [
  {
    id: "scene-ep1-sunrise",
    src: "assets/scenes/episode-01-01-aurelis-city-sunrise-imagegen.png",
    alt: "Sunrise over Aurelis City with crystal spires, glass bridges, and floating transport sigils",
    title: "Sunrise Over Aurelis City",
    caption: "Pale gold light stretched across the clouds, between the white towers and glass bridges of the capital.",
    after: "The morning sky over **Aurelis City** caught the sun in layered gold",
    orientation: "wide",
  },
  {
    id: "scene-ep1-arrival",
    src: "assets/scenes/episode-01-aurelis-arrival.webp",
    alt: "Haru arriving before the grand crystal towers and wards of Aurelis Arcane Academy",
    title: "Aurelis Academy Gates",
    caption: "The academy rose before me in white stone and fractured sunlight beneath six rune-marked towers.",
    after: "Tall crystal windows reflected fractured sunlight beneath six rune-marked towers.",
    orientation: "portrait",
  },
  {
    id: "scene-ep1-whispers",
    src: "assets/scenes/episode-01-gate-whispers.webp",
    alt: "Haru walking through the academy courtyard past whispering students judging his Green Circle crest",
    title: "The Courtyard Whispers",
    caption: "Nearby students murmured as I passed, Blue and Red crests flashing as they noticed my Green emblem with amused disbelief.",
    after: "They knew the three facts before I reached my first corridor: transfer student, mid-year entry, Green Circle.",
    orientation: "portrait",
  },
  {
    id: "scene-ep1-selene-entrance",
    src: "assets/scenes/episode-01-selene-entrance.webp",
    alt: "Instructor Selene Varis with her glowing rune-glass tablet meeting Haru Aerlen under the starry domed hall",
    title: "Instructor Selene Varis",
    caption: "Instructor Selene checks transfer credentials beneath the starry dome of the entrance hall, warning that Aurelis rewards only excellence.",
    after: 'Instructor Selene: "I\'m Instructor Selene Varis. Student Affairs. You\'re the transfer from Lumeris District?"',
    orientation: "wide",
  },
  {
    id: "scene-ep1-lecture",
    src: "assets/scenes/episode-01-02-circle-ranks-classroom.webp",
    alt: "Classroom lecture on the circle ranking hierarchy and four recognized circles",
    title: "The Circle Hierarchy Lecture",
    caption: "Instructor Dren explains human mana potential across the four recognized ranks: Green, Blue, Red, and Yellow.",
    after: 'Instructor Dren: "As I was saying, magical society classifies human mana potential into four recognized Circle ranks."',
    orientation: "wide",
  },
  {
    id: "scene-ep1-classroom-disks",
    src: "assets/scenes/episode-01-classroom-disks.webp",
    alt: "Classroom practice with elemental disks floating in air as students channel mana under glowing circle crests",
    title: "Elemental Practice Disks",
    caption: "Leon Varek channels water-colored blue mana to strike the floating practice disk as Instructor Dren demonstrates circle capacity.",
    after: "Blue mana struck the second disk. It jumped twice as high as the Green one",
    orientation: "wide",
  },
  {
    id: "scene-ep1-black-circle-question",
    src: "assets/scenes/episode-01-black-circle-question.webp",
    alt: "Haru raising his hand to question the mythical fifth Black Circle while students smirk",
    title: "Questioning the Fifth Circle",
    caption: "In academic practice, Black Circle is not treated as reality-yet Haru asks about the suppressed records.",
    after: 'Instructor Dren: "But there is no verified historical evidence that any human has ever possessed such a circle. In academic practice, Black Circle is not treated as reality."',
    orientation: "portrait",
  },
  {
    id: "scene-ep1-arena-platform",
    src: "assets/scenes/episode-03-ladder-arrival.webp",
    alt: "The grand circular arena with crystal spires, ward barriers, and amphitheater stands for assessment combat",
    title: "The Assessment Arena",
    caption: "The training complex opened into a vast circular arena enclosed by crystalline ward pylons and tiers of watchful students.",
    after: "The training complex was larger than the classroom blocks, built in white stone reinforced with metallic mana-",
    orientation: "portrait",
  },
  {
    id: "scene-ep1-duel",
    src: "assets/scenes/episode-01-03-leon-varek-assessment.webp",
    alt: "Leon Varek conjuring water arcs against Haru Aerlen in the academy assessment arena",
    title: "The Arena Assessment Duel",
    caption: "Leon dropped into the arena with easy confidence, blue mana curling around his hands like ribbons of water.",
    after: "Leon dropped from the platform into the arena with easy confidence.",
    orientation: "wide",
  },
  {
    id: "scene-ep1-water-lances",
    src: "assets/scenes/episode-03-water-pressure.webp",
    alt: "Leon unleashing whipping streams of water mana while Haru raises a subtle geometric mana shield",
    title: "Water Lances & Faint Shield",
    caption: "Three whip-like streams crack across the arena floor as Haru deflects the pressure with a faint, precise mana shield.",
    after: "A thin mana shield appeared in front of me-faint, uneven",
    orientation: "portrait",
  },
  {
    id: "scene-ep1-duel-aftermath",
    src: "assets/scenes/episode-01-duel-aftermath.webp",
    alt: "Leon staring in shock at his collapsing water spell as Haru stands restrained and Dren observes",
    title: "Subtle Cancellation",
    caption: "The unstable water sphere folded inward with a wet, airless thump, falling as harmless rain while Leon stared at his hand.",
    after: "The unstable sphere above Leon's hand folded inward with a wet, airless thump.",
    orientation: "portrait",
  },
  {
    id: "scene-ep1-rhea-notices",
    src: "assets/scenes/episode-01-rhea-notices.webp",
    alt: "Student Council President Rhea Valmont observing Haru from the high arena balcony",
    title: "Rhea Valmont's Gaze",
    caption: "At the top of the stairs stood the Student Council President, her calculation sharp behind an unreadable smile.",
    after: "At the top of the stairs stood a girl in the formal elite mantle reserved for special-ranking students.",
    orientation: "portrait",
  },
  {
    id: "scene-ep1-rumor-courtyard",
    src: "assets/scenes/episode-02-rumor-courtyard.webp",
    alt: "Haru and Aira walking through the sunlit academy courtyard as students whisper and Leon glares from the colonnade",
    title: "The Courtyard Rumors",
    caption: "Whispers ripple across the courtyard as students dissect how a Green Circle transfer broke Leon Varek's water spell.",
    after: "By the time I entered the main courtyard of **Aurelis Arcane Academy**, students were already talking",
    orientation: "portrait",
  },
  {
    id: "scene-ep1-aira-tea",
    src: "assets/scenes/episode-01-04-aira-tea-corridor.webp",
    alt: "Aira offering Haru tea in the sunlit gallery corridor after classes",
    title: "Efficient Friendliness",
    caption: "Aira offers Haru tea in the corridor as rumors of the assessment duel ripple through the academy.",
    after: 'Aira: "It\'s tea. I didn\'t know what you liked, so I picked the least risky option."',
    orientation: "wide",
  },
  {
    id: "scene-ep1-elira-corridor",
    src: "assets/scenes/episode-02-09-elira-corridor-radiance-imagegen.webp",
    alt: "Elira Vale walking down the academy corridor in ceremonial gold mantle as students part in natural deference",
    title: "The Parting Corridor",
    caption: "Students instinctively clear a path down the center of the sunlit gallery as Yellow Circle prodigy Elira Vale passes.",
    after: "The students ahead began moving aside almost instinctively, clearing a path down the center of the corridor.",
    orientation: "wide",
  },
  {
    id: "scene-ep1-elira-lunch",
    src: "assets/scenes/episode-01-05-elira-lunch-table.webp",
    alt: "Elira Vale sitting gracefully at the lunch table with Haru and Aira in the grand hall",
    title: "The Yellow Circle at Lunch",
    caption: "Elira Vale joins Haru and Aira at their side table, quiet elegance commanding the attention of the hall.",
    after: "Elira sat gracefully across from us.",
    orientation: "wide",
  },
  {
    id: "scene-ep1-training-terrace",
    src: "assets/scenes/episode-02-training-gardens.webp",
    alt: "Elira demonstrating intricate mana circles on the high training terrace overlooking Aurelis spires",
    title: "Training Terrace Gathering",
    caption: "Elite students take positions on the high open terrace as Elira demonstrates spell formation above the valley cliffs.",
    after: "At the center of the terrace, several elite students took their positions. Two high-grade Reds. One specialized Blue. And Elira.",
    orientation: "portrait",
  },
  {
    id: "scene-ep1-elira-garden",
    src: "assets/scenes/episode-01-06-elira-yellow-circle-garden.webp",
    alt: "Elira demonstrating radiant golden-white threads in the upper training terrace gardens",
    title: "Radiant Silk in the Gardens",
    caption: "Golden-white threads unfolded from Elira's fingertips like woven silk, refining the spell structure with effortless grace.",
    after: "Golden-white threads unfolded from her fingertips and spread across the air like woven silk",
    orientation: "wide",
  },
  {
    id: "scene-ep1-terrace-challenge",
    src: "assets/scenes/episode-02-terrace-challenge.webp",
    alt: "Leon Varek confronting Haru and Elira on the sunset terrace with narrowed eyes and clenched fists",
    title: "The Terrace Confrontation",
    caption: "Leon stops a few paces away in disbelief as sunset gilds the terrace, demanding Haru answer for the assessment duel.",
    after: "Leon stopped a few paces away from us, his eyes moving from Elira to me with visible disbelief.",
    orientation: "portrait",
  },
  {
    id: "scene-ep1-hidden-watcher",
    src: "assets/scenes/episode-02-hidden-watcher.webp",
    alt: "A hooded figure watching Haru and Elira from the shadows of the evening courtyard garden pillars",
    title: "The Hidden Watcher",
    caption: "A quiet, calculating presence lingers at the edge of the twilight gardens, observing from the marble colonnade.",
    after: "Before I could isolate the mana signature, it vanished.",
    orientation: "portrait",
  },
  {
    id: "scene-ep1-healer-cloth",
    src: "assets/scenes/episode-03-west-corridor.webp",
    alt: "Elira and Haru conversing in the moonlit west corridor as Elira offers clean healer fabric for his arm",
    title: "The Healer's Cloth",
    caption: "In the quiet west corridor beneath moonlit glass, Elira offers medicinal healer fabric for Haru's wounded arm.",
    after: "She held a folded strip of white cloth in one hand. Healer fabric.",
    orientation: "portrait",
  },
];
...
const episodes = episodeMeta.filter((meta) => !meta.skip).map((meta) => {
  ...
  return {
    ...
    body: extracted.body,
    cover: meta.file && fs.existsSync(path.join(root, "assets", "episodes", meta.file))
      ? `assets/episodes/${meta.file}`
      : "",
    scenes: meta.id === "ep1" ? episode1Scenes : [],
  };
});
...
<body class="landing-active">
  ...
  <section class="landing-cover" id="landingCover" aria-label="Black Circle landing cover">
    ...
    <div class="landing-shell">
      ...
      <div class="landing-content">
        ...
        <p class="landing-kicker">✦ Aurelis Arcane Archive ✦</p>
        <h1 class="landing-title">Black <span>Circle</span></h1>
        <p class="landing-subtitle">A long-form academy fantasy about rank, restraint, witness, and the only known Black Circle magician.</p>
        <div class="landing-rank-strip" id="landingMagicRanks" aria-label="Magic circle ranks">
          <span class="landing-rank-chip rank-green" data-rank="green"><span class="landing-rank-dot" style="background:#2bd576"></span>Green 60%</span>
          <span class="landing-rank-chip rank-blue" data-rank="blue"><span class="landing-rank-dot" style="background:#2f80ed"></span>Blue 30%</span>
          <span class="landing-rank-chip rank-red" data-rank="red"><span class="landing-rank-dot" style="background:#ef476f"></span>Red 9%</span>
          <span class="landing-rank-chip rank-yellow" data-rank="yellow"><span class="landing-rank-dot" style="background:#ffd166"></span>Yellow 1%</span>
          <span class="landing-rank-chip rank-black" data-rank="black"><span class="landing-rank-dot" style="background:#050505"></span>Black hidden</span>
        </div>
        <div class="landing-actions" aria-label="Landing actions">
          <button class="landing-action landing-primary" type="button" id="enterCircle">
            <svg viewBox="0 0 24 24" width="20" height="20" aria-hidden="true"><circle cx="12" cy="12" r="9" fill="none" stroke="currentColor" stroke-width="2"/><polygon points="10 8 16 12 10 16 10 8" fill="currentColor"/></svg>
            <span>Enter the Circle</span>
          </button>
          <button class="landing-action" type="button" id="openTome">
            <svg viewBox="0 0 24 24" width="20" height="20" aria-hidden="true"><path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H20v20H6.5a2.5 2.5 0 0 1-2.5-2.5Z" fill="none" stroke="currentColor" stroke-width="2"/><path d="M6 6h10M6 10h10" stroke="currentColor" stroke-width="2"/></svg>
            <span>The Tome & Cast</span>
          </button>
        </div>
      </div>
  ...
  <div class="app-shell">
    ...
    <header class="hero" id="readerStart">
      <div class="hero-inner">
        <button class="cover-return" type="button" id="coverButton" aria-label="Return to cover landing">
          <svg viewBox="0 0 24 24" width="16" height="16" aria-hidden="true"><path d="M19 12H5M12 19l-7-7 7-7" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"/></svg>
        ...
        <div class="circle-strip" id="magicRanks" aria-label="Magic circle ranks">
          <span class="circle-chip rank-green" data-rank="green"><span class="dot" style="background:#2bd576"></span>Green 60%</span>
          <span class="circle-chip rank-blue" data-rank="blue"><span class="dot" style="background:#2f80ed"></span>Blue 30%</span>
          <span class="circle-chip rank-red" data-rank="red"><span class="dot" style="background:#ef476f"></span>Red 9%</span>
          <span class="circle-chip rank-yellow" data-rank="yellow"><span class="dot" style="background:#ffd166"></span>Yellow 1%</span>
          <span class="circle-chip rank-black" data-rank="black"><span class="dot" style="background:#070707"></span>Black hidden</span>
        </div>
      </div>
    </header>
    ...
    <main class="main">
      ...
      <header class="episode-hero-banner" id="episodeHeroBanner" aria-label="Episode 4K Cover Banner">
        <div class="hero-banner-media">
          <img id="heroBannerImg" src="${episodes[1]?.cover || ''}" alt="${escapeHtml(episodes[1]?.title || '')} 4K episode cover banner" loading="eager" decoding="async" data-lightbox-image role="button" tabindex="0" aria-label="Expand 4K cover banner">
          <div class="hero-banner-overlay" aria-hidden="true"></div>
          <div class="hero-banner-content">
            <div class="hero-banner-meta">
              <span class="hero-banner-badge" id="heroBannerBadge">${episodes[1]?.displayEyebrow || ''} &bull; ${episodes[1]?.displayNumber || ''}</span>
              <span class="hero-banner-pill">4K UHD</span>
            </div>
            <h1 class="hero-banner-title" id="heroBannerTitle">${escapeHtml(episodes[1]?.title || '')}</h1>
            <p class="hero-banner-recap" id="heroBannerRecap">${escapeHtml(episodes[1]?.recap || '')}</p>
            <div class="hero-banner-actions">
              <button class="hero-banner-action primary" type="button" id="heroBannerReadBtn">Read Story &darr;</button>
              <button class="hero-banner-action secondary" type="button" id="heroBannerZoomBtn" aria-label="Expand 4K artwork">View 4K Artwork</button>
            </div>
          </div>
        </div>
      </header>
  ...
  <script>
    ...
    function showReader(targetId = "readerStart", options = {}) {
      ...
      const target = document.getElementById(targetId);
      const scrollTarget =
        targetId === "reader" || targetId === "episodeNav"
          ? (document.querySelector(".nav-panel") || target || reader)
          : (targetId === "readerStart" && window.matchMedia("(max-width: 700px)").matches ? reader : target);
      if (scrollTarget && options.scroll !== false) {
    ...
    function setTheme(theme) {
      ...
      themeToggle.innerHTML = '<span class="theme-btn-icon" aria-hidden="true">' + icon + '</span> <span class="theme-btn-text">' + label + '</span>';
      themeToggle.setAttribute("aria-label", isDark ? "Switch to light mode" : "Switch to dark mode");
      if (landingThemeToggle) {
        landingThemeToggle.innerHTML = '<span class="theme-btn-icon" aria-hidden="true">' + icon + '</span> <span class="theme-btn-text">' + label + '</span>';
    ...
    function renderBody(body, scenes = []) {
      ...
      return body
        ...
        .map((block) => {
          ...
          if (scene) {
            scene.placed = true;
            return \`<div class="scene-anchor" id="\${escapeHtml(scene.id || "")}">
  \${html}
  <aside class="scene-callout" aria-label="\${escapeHtml(scene.title || "Scene illustration")}">
    <figure class="scene-figure">
      <div class="scene-img-wrap">
        <img src="\${escapeHtml(scene.src)}" alt="\${escapeHtml(scene.alt)}" loading="lazy" decoding="async" data-lightbox-image role="button" tabindex="0" aria-label="Expand \${escapeHtml(scene.title || "scene illustration")}">
      </div>
      \${scene.title || scene.caption ? \`
      <figcaption class="scene-caption">
        \${scene.title ? \`<strong class="scene-title">\${escapeHtml(scene.title)}</strong>\` : ""}
        \${scene.caption ? \`<span class="scene-desc">\${escapeHtml(scene.caption)}</span>\` : ""}
      </figcaption>\` : ""}
    </figure>
  </aside>
</div>\`;
    ...
    function renderEpisode(index, options = {}) {
      ...
      const banner = document.getElementById("episodeHeroBanner");
      const bannerImg = document.getElementById("heroBannerImg");
      const bannerBadge = document.getElementById("heroBannerBadge");
      const bannerTitle = document.getElementById("heroBannerTitle");
      const bannerRecap = document.getElementById("heroBannerRecap");

      if (banner && bannerImg && bannerBadge && bannerTitle) {
        if (episode.cover) {
          banner.hidden = false;
          banner.classList.remove("banner-hidden");
          bannerImg.src = episode.cover;
          bannerImg.alt = \`\${episode.title} 4K episode cover banner\`;
          bannerBadge.innerHTML = \`\${episode.displayEyebrow} &bull; \${episode.displayNumber}\`;
          bannerTitle.textContent = episode.title;
          if (bannerRecap) {
            bannerRecap.textContent = episode.recap || "";
            bannerRecap.hidden = !episode.recap;
          }
        } else {
          banner.hidden = true;
      ...
      reader.innerHTML = \`
        ...
        <div class="story-body">\${renderBody(episode.body, episode.scenes || [])}</div>
    ...
    function init() {
      ...
      document.getElementById("heroBannerZoomBtn")?.addEventListener("click", () => {
        const img = document.getElementById("heroBannerImg");
        if (img) openLightbox(img);
      });
      document.getElementById("heroBannerReadBtn")?.addEventListener("click", () => {
