...
- `workspace_search`: token-efficient file search with line hits
- `workspace_read`: ranged file reads with line numbers
- `workspace_outline`: compact file and symbol outline
- `workspace_diff`: bounded git diff summary
